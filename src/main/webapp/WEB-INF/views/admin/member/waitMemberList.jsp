	...
	<div class="row">
		<div class="col-12">
			<div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
				<p class="mb-sm-0" style="font-size:18px; color: #495057;"><i class="ri-file-edit-line"></i><strong> 가입 신청 현황  </strong></p>
				<div class="page-title-right">
					<ol class="breadcrumb m-0">
						<li class="breadcrumb-item"><a href="javascript: void(0);">입주민 관리</a></li>
						<li class="breadcrumb-item active">가입 신청 현황</li>
					</ol>
				</div>
			</div>
		</div>
							...
							<table role="grid" class="gridjs-table" style="height: auto;">
								<thead class="gridjs-thead">
									<tr class="gridjs-tr">
										...
										<th data-column-id="memNm" class="gridjs-th" style="width: 150px; text-align: center;">
										...
										<th data-column-id="memBirth" class="gridjs-th" style="width: 150px; text-align: center;">
			...
			success: function (data) {
				...
				$.each(data, function (index, memberVO) {
					...
					let rejectBtn = $('<button>')
						...
						.text('반려')
						.click(function () {
							signAction(memberVO.memId + "님의 회원가입을 반려 하시겠습니까?", "/admin/signNo", memberVO.memId, "처리 완료");
						});

					let actionCell = $('<td>').addClass('gridjs-td').css('text-align', 'center');
