...
<link href="/resources/assets/libs/sweetalert2/sweetalert2.min.css"
	rel="stylesheet" type="text/css" />

</head>
<body>
	<div
		style="width: 100%; overflow-x: auto; display: flex; align-items: center;"
		class="auth-page-content" class="row">
		<div class="container">
			<!-- end row -->
						...
						<form id="upForm" enctype="multipart/form-data">
							<div class="card-body p-4">
								...
								<div class="p-2 mt-4">
												...
												<div
													...
													<div
														...
														<input id="profImg" type="file"
															...
															accept="image/*"> <label for="profImg"
									...
									<div class="mb-3">
										<label for="memId" class="form-label">아이디 <span
									...
									<div class="mb-3">
										<label for="aptSelect" class="form-label">입주 아파트 <span
											class="text-danger">*</span>
										</label> <select id="aptSelect" class="form-select">
									...
									<div class="input-group mb-6">
										<select class="form-select mb-3" id="aptNum"
											data-choice="active">
											<option value="" selected>선택하세요</option>
										</select> <span class="input-group-text mb-3">동</span> <input
											type="text" class="form-control mb-3" id="roomNum"
											placeholder="호실" required> <span
									...
									<div class="mb-3">
										...
										<div class="position-relative auth-pass-inputgroup">
											<input type="password"
												class="form-control pe-5 password-input" placeholder="비밀번호"
									...
									<div class="mb-3">
										...
										<div class="position-relative auth-pass-inputgroup">
											<input type="password"
												...
												placeholder="비밀번호 확인" id="memPwChk"
									...
									<div class="mb-3">
										<label for="JoiningdatInput" class="form-label">연락처 <span
											class="text-danger">*</span></label> <input type="text"
											class="form-control" id="memTelno" name="memTelno"
											placeholder="연락처" maxlength="15" required>
									</div>
									<div class="input-group mb-6">
										...
										<div class="input-group mb-6">
											<input type="text" class="form-control mb-3" id="emailId"
												name="emailId" placeholder="아이디" aria-label="Email" required>
											<span class="input-group-text mb-3">@</span> <input
												type="text" class="form-control mb-3" id="dirEmail"
												name="dirEmail" value="선택하세요" readonly /> <select
												class="form-select mb-3" name="selectEmail" id="selectEmail"
												data-choice="active">
												<option value="" selected>선택하세요</option>
									...
									<div class="mb-3">
										<label for="JoiningdatInput" class="form-label">세대주 계정
											명</label> <input type="text" class="form-control" id="hshldrId"
											name="hshldrId" placeholder="동거인일 경우 입력해주세요.">
									</div>
									<div class="mb-3">
										<input type="button" class="btn btn-primary w-100"
											value="가입신청" id="btn_submit">
									</div>
								</div>
							</div>
						</form>
	...
	<script
		src="/resources/assets/libs/bootstrap/js/bootstrap.bundle.min.js"></script>
